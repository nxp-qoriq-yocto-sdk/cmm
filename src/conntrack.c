...
char ScratchBuf[512] __attribute__ ((aligned (16)));
...
{
        struct nf_conntrack *CtClone = (struct nf_conntrack* )ScratchBuf;
								...
								unsigned int Dport4o6, const char *dir)
{
	...
	flow.flow_flags = FLOWFLAG_LOCAL | FLOWFLAG_FLOATING_TUNNEL;
